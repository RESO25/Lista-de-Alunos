...
function adicionarNovoAluno(){
    ...
    var xDel = document.createElement("p");
    xDel.textContent = "X";
    xDel.classList.add("btnDel");

    var celulaDel = document.createElement("td");
    celulaDel.appendChild(xDel);

    xDel.addEventListener('click', deletarLinha);

    function deletarLinha(){
        xDel.parentNode.parentNode.remove();
    }
    ...
    novaLinha.appendChild(celulaDel);
